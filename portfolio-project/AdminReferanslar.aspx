<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminReferanslar.aspx.cs" Inherits="portfolio_project.AdminReferanslar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
        ...
        <asp:HyperLink NavigateUrl="~/AdminReferansEkle.aspx" ID="HyperLink3" runat="server" CssClass="btn btn-primary">Referans Ekle</asp:HyperLink>
</asp:Content>
