<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminKazanimlar.aspx.cs" Inherits="portfolio_project.AdminKazanimlar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:HyperLink NavigateUrl="~/AdminKazanimEkle.aspx" ID="HyperLink3" runat="server" CssClass="btn btn-primary">Kazanım Ekle</asp:HyperLink>
</asp:Content>
